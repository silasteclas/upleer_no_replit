          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-4">
                ...
                <div className="mt-6 text-center space-y-3 bg-gradient-to-br from-blue-50 via-green-50 to-purple-50 rounded-lg p-4 border border-blue-200 shadow-md">
                  <div className="text-lg font-bold text-blue-700">🚀 Quase lá!</div>
                  <div className="text-sm text-gray-700 font-medium">
                    <div>Finalize agora e comece a lucrar</div>
                    <div>com sua apostila em múltiplos canais!</div>
                  </div>
                  <div className="bg-gradient-to-r from-green-100 to-blue-100 border border-green-300 rounded-lg p-3 mt-3 shadow-sm">
